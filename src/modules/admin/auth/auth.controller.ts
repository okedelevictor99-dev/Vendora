...
export const sendAdminVerification = asyncHandler(
  async (req: Request, res: Response) => {
    const { name, email } =
      req.validatedBody;

    await sendAdminVerificationService(
      { name, email }
    );
...
export const resendAdminVerification =
  asyncHandler(
    async (req: Request, res: Response) => {
      const { email } =
        req.validatedBody;

      await resendAdminVerificationService(
        email
      );
...
export const adminRefreshToken =
  asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const tokens =
        await adminRefreshTokenService(
          refreshToken
        );
...
export const adminForgotPassword =
  ...
  export const resendAdminForgotPassword =
  asyncHandler(
    async (req: Request, res: Response) => {
      const { email } =
        req.validatedBody;

      await resendAdminForgotPasswordService(
        email
      );
