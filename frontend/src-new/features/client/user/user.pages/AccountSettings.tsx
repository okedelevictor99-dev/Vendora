...
const AccountSettingsPage = () => {
  ...
  const handleConfirm = async () => {
    ...
    if (confirmType === "logoutAll") {
      try {
        await logoutAll();

        // logoutAll's onSuccess already clears:
        // access token
        // refresh token
        // user
    ...
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(260px,320px)_1fr]">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-between">
              ...
              {!isEditingName && (
                <button
                  ...
                  className="text-xs text-[#E8682F] hover:underline"
                >
                  Edit
                </button>
              )}
          ...
          <div className="rounded-xl border border-[#E5E2DA] bg-white p-5">
            <div>
              <h2 className="text-sm font-semibold text-[#14151A]">
                Security
              </h2>
            ...
            <div className="mt-4 flex flex-col gap-4 border-t border-[#E5E2DA] pt-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-sm font-medium text-[#14151A]">
                  Log out of all devices
                </p>

                <p className="mt-1 max-w-lg text-xs leading-5 text-[#8B8B85]">
                  Sign out of your account on every device where
        ...
        message={
          confirmType === "email"
            ...
            : confirmType === "password"
              ...
              : "This will sign you out of every device where your account is currently logged in. You will also be signed out on this device."
        }
        confirmLabel={
          confirmType === "logoutAll"
            ? "Log out all devices"
            : "Confirm"
        }
        isLoading={
