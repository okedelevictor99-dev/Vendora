...
import {
  adminLoginSchema,
  type AdminLoginFormValues,} from "@/features/admin/auth/auth.validation"
...
const AdminLogin = () => {
  ...
  const { adminLogin, isAdminLoggingIn, adminLoginError } = useAdminAuth();
        ...
        <div className="relative hidden w-1/2 items-center justify-center overflow-hidden bg-[#14151A] md:flex">
          ...
          <div className="relative px-12 text-center">
            <p className="font-serif text-6xl leading-[1.1] text-[#FAF8F4]">
              Run it.
              <br />
              <span className="text-[#E8682F]">Manage it.</span>
              <br />
              Vendora it.
            </p>
          </div>
